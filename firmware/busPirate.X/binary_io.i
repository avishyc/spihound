...
void handle_bitbang_command(const bitbang_command command) {
  ...
  case BITBANG_COMMAND_JTAG_XSVF:
    ...
    bp_enable_voltage_regulator();
    bp_message_write_buffer(__builtin_tbladdress(MSG_XSV1_MODE_IDENTIFIER_str));
    jtag();
...
uint8_t bitbang_pin_direction_set(const uint8_t direction_mask) {
  ...
  TRISDbits.TRISD5 = (direction_mask & 0b00010000) ? 1 : 0;
  TRISDbits.TRISD1 = (direction_mask & 0b00001000) ? 1 : 0;
  TRISDbits.TRISD2 = (direction_mask & 0b00000100) ? 1 : 0;
  TRISDbits.TRISD3 = (direction_mask & 0b00000010) ? 1 : 0;
  TRISDbits.TRISD4 = (direction_mask & 0b00000001) ? 1 : 0;
  ...
  return ((PORTDbits.RD5 == 1) ? 0b00010000 : 0b00000000) |
         ((PORTDbits.RD1 == 1) ? 0b00001000 : 0b00000000) |
         ((PORTDbits.RD2 == 1) ? 0b00000100 : 0b00000000) |
         ((PORTDbits.RD3 == 1) ? 0b00000010 : 0b00000000) |
         ((PORTDbits.RD4 == 1) ? 0b00000001 : 0b00000000);
}
...
uint8_t bitbang_pin_state_set(const uint8_t state_mask) {
  ...
  PORTDbits.RD5 = (state_mask & 0b00010000) ? 1 : 0;
  PORTDbits.RD1 = (state_mask & 0b00001000) ? 1 : 0;
  PORTDbits.RD2 = (state_mask & 0b00000100) ? 1 : 0;
  PORTDbits.RD3 = (state_mask & 0b00000010) ? 1 : 0;
  PORTDbits.RD4 = (state_mask & 0b00000001) ? 1 : 0;
...
void bp_binary_io_peripherals_set(unsigned char inByte) {
  ...
  TRISDbits.TRISD5 = 0;
  PORTDbits.RD5 = (inByte & 0b00000010) ? 1 : 0;


  if (inByte & 0b1) {
    if (mode_configuration.high_impedance == 1) {
      TRISD |= 0b0000000000010000;
    } else {
...
_Bool bp_binary_io_pullup_control(uint8_t control_byte) {
  ...
  _Bool has_voltage = bp_read_adc(5) > 0x0100;
...
# 1238 "../binary_io.c"
  OC5CON1 = 0x0000;
# 1255 "../binary_io.c"
  RPOR10bits.RP20R = 0x00;

  do { user_serial_transmit_character(0x01); } while (0);
}

void read_and_transmit_adc_measurement(void) {
  uint16_t value = bp_read_adc(1);
