...
# 1 "../jtag/../hardware.h" 1
# 26 "../jtag/../hardware.h"
# 1 "../jtag/../dp_usb/usb_stack_globals.h" 1
...
# 1 "../jtag/../dp_usb/../prj_usb_config.h" 1
# 10 "../jtag/../dp_usb/usb_stack_globals.h" 2
# 1 "../jtag/../dp_usb/usb_stack.h" 1
# 19 "../jtag/../dp_usb/usb_stack.h"
# 1 "../jtag/../dp_usb/../dp_usb/picusb.h" 1
# 320 "../jtag/../dp_usb/../dp_usb/picusb.h"
...
# 321 "../jtag/../dp_usb/../dp_usb/picusb.h" 2
# 343 "../jtag/../dp_usb/../dp_usb/picusb.h"
typedef unsigned int usb_uep_t;
# 521 "../jtag/../dp_usb/../dp_usb/picusb.h"
...
# 20 "../jtag/../dp_usb/usb_stack.h" 2
# 89 "../jtag/../dp_usb/usb_stack.h"
typedef enum
{
DETACHED_STATE = 0x00,
ATTACHED_STATE = 0x01,
...
# 11 "../jtag/../dp_usb/usb_stack_globals.h" 2
# 1 "../jtag/../dp_usb/cdc.h" 1
# 18 "../jtag/../dp_usb/cdc.h"
void cdc_setup(void);
...
# 12 "../jtag/../dp_usb/usb_stack_globals.h" 2
# 27 "../jtag/../hardware.h" 2
# 1 "../jtag/../hardwarev4.h" 1
# 21 "../jtag/../hardwarev4.h"
# 1 "../jtag/../types.h" 1
# 21 "../jtag/../types.h"
...
# 1 "c:\\program files (x86)\\microchip\\xc16\\v1.41\\bin\\bin\\../..\\include/stdint.h" 1 3 4
# 23 "../jtag/../types.h" 2
# 22 "../jtag/../hardwarev4.h" 2
# 180 "../jtag/../hardwarev4.h"
...
# 28 "../jtag/../hardware.h" 2
# 1 "../jtag/../onboard_eeprom.h" 1
# 30 "../jtag/../onboard_eeprom.h"
...
int xsvfInfoInit( SXsvfInfo* pXsvfInfo )
{
    ...
    pXsvfInfo->ucCommand = 0;
    pXsvfInfo->lCommandCount = 0;
    pXsvfInfo->iErrorCode = 0;
    pXsvfInfo->ucMaxRepeat = 0;
    pXsvfInfo->ucTapState = 0x00;
    pXsvfInfo->ucEndIR = 0x01;
    pXsvfInfo->ucEndDR = 0x01;
    ...
    if ( ucTargetState == 0x00 )
    {
        ...
        *pucTapState = 0x00;
        ;
              ...
              ( ( ( ucTargetState == 0x07 ) && ( *pucTapState != 0x06 ) ) ||
                ( ( ucTargetState == 0x0E ) && ( *pucTapState != 0x0D ) ) ) )
    {
                    ...
                    int iExitShift )
{
    ...
    while ( lNumBits )
    {
        ...
        for ( i = 0; ( lNumBits && ( i < 8 ) ); ++i )
        {
            ...
            setPort( (short) 2, (short)(ucTdiByte & 1) );
            ucTdiByte >>= 1;
               ...
               unsigned char ucMaxRepeat )
{
    ...
    if ( !lNumBits )
    {
        ...
        if ( lRunTestTime )
        {
            ...
            xsvfGotoTapState( pucTapState, 0x01 );
            ;
        ...
        do
        {
            ...
            if ( iExitShift )
            {
                ...
                if ( iMismatch && lRunTestTime && ( ucRepeat < ucMaxRepeat ) )
                {
                    ...
                    xsvfGotoTapState( pucTapState, 0x06 );

                    xsvfGotoTapState( pucTapState, 0x04 );
                      ...
                      unsigned char ucMaxRepeat )
{
    ...
    return( xsvfShift( pucTapState, 0x04, lShiftLengthBits,
...
int xsvfDoXSIR( SXsvfInfo* pXsvfInfo )
{
    ...
    else
    {
        ...
        iErrorCode = xsvfShift( &(pXsvfInfo->ucTapState), 0x0B,
...
int xsvfDoXSDR( SXsvfInfo* pXsvfInfo )
{
    ...
    iErrorCode = xsvfShift( &(pXsvfInfo->ucTapState), 0x04,
...
int xsvfDoXSDRSIZE( SXsvfInfo* pXsvfInfo )
{
    ...
    ;
    if ( pXsvfInfo->sShiftLengthBytes > 50 )
    {
        iErrorCode = 6;
        pXsvfInfo->iErrorCode = iErrorCode;
    }
...
int xsvfDoXSDRBCE( SXsvfInfo* pXsvfInfo )
{
    unsigned char ucEndDR;
    int iErrorCode;
    ucEndDR = (unsigned char)(( pXsvfInfo->ucCommand == 14 ) ?
                                pXsvfInfo->ucEndDR : 0x04);
    iErrorCode = xsvfBasicXSDRTDO( &(pXsvfInfo->ucTapState),
                                    pXsvfInfo->lShiftLengthBits,
                                    pXsvfInfo->sShiftLengthBytes,
                                    &(pXsvfInfo->lvTdi),
...
int xsvfDoXSDRTDOBCE( SXsvfInfo* pXsvfInfo )
{
    unsigned char ucEndDR;
    int iErrorCode;
    ucEndDR = (unsigned char)(( pXsvfInfo->ucCommand == 17 ) ?
                                pXsvfInfo->ucEndDR : 0x04);
    iErrorCode = xsvfBasicXSDRTDO( &(pXsvfInfo->ucTapState),
                                    pXsvfInfo->lShiftLengthBits,
                                    pXsvfInfo->sShiftLengthBytes,
