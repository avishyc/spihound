...
# 32 "c:\\program files (x86)\\microchip\\xc16\\v1.41\\bin\\bin\\../..\\include/stdio.h" 3 4
...
static _Bool __attribute__((address(0x47FA), persistent)) skip_pgc_pgd_check;
  ...
  for (;;) {
    ...
    while (!stop) {
      ...
      case 'k':
        ...
        bp_message_write_line(__builtin_tbladdress(BPMSG1263_str));
        break;

      case 'K':
        mode_configuration.alternate_aux = 3;
        bp_message_write_line(__builtin_tbladdress(BPMSG1264_str));
        break;
      ...
      case '#':
        ...
        bp_message_write_line(__builtin_tbladdress(MSG_RESET_MESSAGE_str));
      bpv4reset:
        print_version_info();
      ...
      case '<':
        ...
        while (cmdbuf[((cmdstart + temp) & (256 - 1))] != 0x00) {
          if (cmdbuf[((cmdstart + temp) & (256 - 1))] == '>')
        ...
        if (mode_configuration.command_error == 0) {
          cmdstart = (cmdstart + 1) & (256 - 1);
          temp = getint();
          if (cmdbuf[((cmdstart)&(256 - 1))] == '=')
          {
            if ((temp > 0) && (temp <= 5)) {
              cmdstart = (cmdstart + 1) & (256 - 1);
              temp--;
      ...
      if (mode_configuration.command_error == 1) {
        ...
        if (cmdstart > oldstart) {
          ...
          bp_write_dec_byte((256 + cmdstart) - oldstart);
        }
        mode_configuration.command_error = 0;
        stop = 1;
        bp_write_line("");
...
int getint(void)
{
  ...
  if ((cmdbuf[((cmdstart + i) & (256 - 1))] >= 0x31) &&
      (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39))
  {
    number = cmdbuf[(cmdstart + i) & (256 - 1)] - 0x30;
    i++;
    while ((cmdbuf[((cmdstart + i) & (256 - 1))] >= 0x30) &&
           (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39))
    {
      number *= 10;
      number += cmdbuf[((cmdstart + i) & (256 - 1))] - 0x30;
  ...
  } else if (cmdbuf[((cmdstart + i) & (256 - 1))] ==
             0x30)
  {
    i++;
    if ((cmdbuf[((cmdstart + i) & (256 - 1))] == 'b') ||
        (cmdbuf[((cmdstart + i) & (256 - 1))] == 'B')) {
      i++;
      while ((cmdbuf[((cmdstart + i) & (256 - 1))] == '1') ||
             (cmdbuf[((cmdstart + i) & (256 - 1))] == '0')) {
        number <<= 1;
        number += cmdbuf[((cmdstart + i) & (256 - 1))] - 0x30;
        i++;
      }
    } else if ((cmdbuf[((cmdstart + i) & (256 - 1))] == 'x') ||
               (cmdbuf[((cmdstart + i) & (256 - 1))] == 'X')) {
      i++;
      while (((cmdbuf[((cmdstart + i) & (256 - 1))] >= 0x30) &&
              (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39)) ||
             ((cmdbuf[((cmdstart + i) & (256 - 1))] >= 'A') &&
              (cmdbuf[((cmdstart + i) & (256 - 1))] <= 'F')) ||
             ((cmdbuf[((cmdstart + i) & (256 - 1))] >= 'a') &&
              (cmdbuf[((cmdstart + i) & (256 - 1))] <= 'f'))) {
        number <<= 4;
        if ((cmdbuf[(cmdstart + i) & (256 - 1)] >= 0x30) &&
            (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39)) {
          number += cmdbuf[((cmdstart + i) & (256 - 1))] - 0x30;
        } else {
          cmdbuf[((cmdstart + i) & (256 - 1))] |= 0x20;
          number +=
              cmdbuf[((cmdstart + i) & (256 - 1))] - 0x57;
        }
        i++;
      }
    } else if ((cmdbuf[((cmdstart + i) & (256 - 1))] >= 0x30) &&
               (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39)) {
      number = cmdbuf[((cmdstart + i) & (256 - 1))] - 0x30;
      while (
          (cmdbuf[((cmdstart + i) & (256 - 1))] >= 0x30) &&
          (cmdbuf[((cmdstart + i) & (256 - 1))] <= 0x39))
      {
        number *= 10;
        number += cmdbuf[((cmdstart + i) & (256 - 1))] - 0x30;
...
uint8_t change_read_display(void) {
  ...
  for (index = 0; index < sizeof(READ_DISPLAY_BASE); index++) {
    if (cmdbuf[(cmdstart + 1) & (256 - 1)] == READ_DISPLAY_BASE[index]) {
      return index + 1;
    }
  }
...
int cmdhistory(void) {
  ...
  while (j != cmdstart)
  {
    if ((cmdbuf[j] == 0x00) && (cmdbuf[(j + 1) & (256 - 1)] !=
                                0x00))
    {
      bp_write_dec_byte(i);
      bp_write_string(". ");
      k = 1;
      while (cmdbuf[((j + k) & (256 - 1))]) {
        user_serial_transmit_character(
            cmdbuf[((j + k) & (256 - 1))]);
        k++;
      }
      historypos[i] = (j + 1) & (256 - 1);
      i++;
      if (i == 15)
        break;
      bp_write_line("");
  ...
  while (cmdbuf[(historypos[j] + i) &
                (256 - 1)])
  {
    cmdbuf[(cmdend + i) & (256 - 1)] = cmdbuf[(historypos[j] + i) & (256 - 1)];
    i++;
  }
  cmdstart = (cmdend - 1) &
             (256 - 1);
  cmdend = (cmdstart + i + 2) & (256 - 1);
  cmdbuf[(cmdend - 1) & (256 - 1)] = 0x00;
...
void print_version_info(void) {
# 1415 "../proc_menu.c"
  bp_write_line("Bus Pirate v4");


  bp_write_string("Community Firmware v7.1 - goo.gl/gCzQnW ");
...
void print_status_info(void) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(MSG_CFG0_FIELD_str));
  bp_write_hex_word(bp_read_from_flash(0x0001, 0x57FA));
  user_serial_transmit_character(' ');


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1136_str));
  bp_write_hex_word(bp_read_from_flash(0x0001, 0x57FC));
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1137_str));
  bp_write_hex_word(bp_read_from_flash(0x0001, 0x57FE));
  bp_write_line("");
  ...
  if (TRISFbits.TRISF5 == 0) {
    bp_message_write_buffer(__builtin_tbladdress(MSG_VPU_5V_MARKER_str));
  }

  if (TRISFbits.TRISF4 == 0) {
    bp_message_write_buffer(__builtin_tbladdress(MSG_VPU_3V3_MARKER_str));
  }
...
void print_pins_information(void) {
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1256_str));
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1257_str));
  ...
  print_pin_direction(0b0000000000000001);
  print_pin_direction(0b0000000100000000);
  print_pin_direction(0b0000000000100000);
  print_pin_direction(0b0000000000010000);
  print_pin_direction(0b0000000000001000);
  print_pin_direction(0b0000000000000100);
  print_pin_direction(0b0000000000000010);
  ...
  bp_write_voltage(bp_read_adc(2));
  ...
  bp_write_voltage(bp_read_adc(0));
  ...
  bp_write_voltage(bp_read_adc(5));
  ...
  bp_write_voltage(bp_read_adc(1));
  ...
  print_pin_state(0b0000000000000001);
  print_pin_state(0b0000000100000000);
  print_pin_state(0b0000000000100000);
  print_pin_state(0b0000000000010000);
  print_pin_state(0b0000000000001000);
  print_pin_state(0b0000000000000100);
  print_pin_state(0b0000000000000010);
...
void print_pin_direction(const uint16_t pin) {
  bp_write_string(TRISD & pin ? "I\t" : "O\t");
}

void print_pin_state(const uint16_t pin) {
  bp_write_string(PORTD & pin ? "H\t" : "L\t");
}
...
void set_pullup_voltage(void) {
  ...
  bp_delay_ms(2);
  bp_enable_adc();
  _Bool has_voltage = (bp_read_adc(5) > 0x100);
  bp_disable_adc();
  if (has_voltage) {
    bp_message_write_line(__builtin_tbladdress(MSG_VOLTAGE_VPULLUP_ALREADY_PRESENT_str));
    mode_configuration.command_error = 1;
    return;
  }
  ...
  if (mode_configuration.command_error == 1) {
    mode_configuration.command_error = 0;
    bp_message_write_line(__builtin_tbladdress(BPMSG1271_str));
  ...
  case 1:
    bp_disable_3v3_pullup();
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1272_str));
    bp_message_write_line(__builtin_tbladdress(BPMSG1274_str));
    break;

  case 2:
    bp_enable_3v3_pullup();
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1173_str));
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1272_str));
    bp_message_write_line(__builtin_tbladdress(BPMSG1273_str));
    break;

  case 3:
    bp_enable_5v0_pullup();
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1171_str));
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1272_str));
    bp_message_write_line(__builtin_tbladdress(BPMSG1273_str));
    break;
...
void handle_backspace(void) {
  ...
  menu_state.cursor_position = (menu_state.cursor_position - 1) & (256 - 1);
...
void refresh_command_line(const uint16_t start) {
  ...
  uint16_t repeat = (start - 1) & (256 - 1);
  uint16_t old_command_start = 0;
  while (repeat != cmdend) {
    if (!cmdbuf[repeat]) {
      old_command_start = (repeat + 1) & (256 - 1);
      break;
    }
    repeat = (repeat - 1) & (256 - 1);
  }
...
void handle_up_arrow(void) {
  ...
  for (character_offset = (cmdstart - 1) & (256 - 1);
       character_offset != cmdend;
       character_offset = (character_offset - 1) & (256 - 1)) {

    if (!cmdbuf[character_offset] &&
        cmdbuf[(character_offset - 1) & (256 - 1)]) {
...
void handle_home_key(void) {
  ...
  size_t repeat = (menu_state.cursor_position - cmdstart) & (256 - 1);
  bp_write_string("\x1B[");
  bp_write_dec_word(repeat);
  bp_write_string("D");
...
void handle_end_key(void) {
  ...
  size_t repeat = (cmdend - menu_state.cursor_position) & (256 - 1);
  bp_write_string("\x1B[");
  bp_write_dec_word(repeat);
  bp_write_string("C");
  menu_state.cursor_position = cmdend;
...
void handle_character(const uint8_t character) {
  if ((((cmdend + 1) & (256 - 1)) != cmdstart) && (character >= 0x20) &&
      (character < 0x7F)) {
...
void switch_psu_on(void) {
  ...
  if ((bp_read_adc(0) > 0x200 - 0x50) && (bp_read_adc(2) > 0x307 - 0x50)) {
