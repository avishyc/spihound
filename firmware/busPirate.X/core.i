...
static inline _Bool raw_read_bit(void) { return bitbang_read_bit(); }

static inline uint16_t raw_read_pin(void) { return bitbang_read_miso(); }

static inline void raw_set_clock_high(void) { bitbang_set_clk(1); }

static inline void raw_set_clock_low(void) { bitbang_set_clk(0); }

static inline void raw_set_data_low(void) { bitbang_set_mosi(0); }

static inline void raw_set_data_high(void) { bitbang_set_mosi(1); }
...
# 138 "../core.c"
static _Bool null_bit_read_callback(void);
...
void null_operation_callback(void) {
  bp_message_write_line(__builtin_tbladdress(MSG_COMMAND_HAS_NO_EFFECT_str));
...
_Bool null_bit_read_callback(void) {
  bp_message_write_line(__builtin_tbladdress(MSG_COMMAND_HAS_NO_EFFECT_str));
  mode_configuration.command_error = 1;
  return 0;
}
...
void empty_print_settings_implementation(void) { bp_write_line(""); }
...
void hiz_print_pins_state(void) { bp_message_write_line(__builtin_tbladdress(MSG_SPI_PINS_STATE_str)); }
