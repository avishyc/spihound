...
# 306 "../sump.c"
    0x21,
    (uint8_t)((uint32_t)4096 >> 24),
    (uint8_t)(((uint32_t)4096 >> 16) & 0xFF),
    (uint8_t)(((uint32_t)4096 >> 8) & 0xFF),
    (uint8_t)((uint32_t)4096 & 0xFF),



    0x23,
    (uint8_t)((uint32_t)1000000 >> 24),
    (uint8_t)(((uint32_t)1000000 >> 16) & 0xFF),
    (uint8_t)(((uint32_t)1000000 >> 8) & 0xFF),
    (uint8_t)((uint32_t)1000000 & 0xFF),
...
# 416 "../sump.c"
static _Bool sump_acquire_samples(void);
...
static _Bool sump_handle_command_byte(uint8_t input_byte);

void enter_sump_mode(void) {


  TRISD |= 0b0000000000100000 + 0b0000000000000010 + 0b0000000000000100 + 0b0000000000001000 + 0b0000000000010000;


  sump_reset();


  sump_handle_command_byte(0x02);
...
void sump_reset(void) {
  ...
  PR5 = (((uint32_t)(0x00000640) >> 16) & 0xFFFF);
  PR4 = ((uint32_t)(0x00000640)&0xFFFF);


  samples_to_acquire = 4096;


  sampler_state = SAMPLER_IDLE;
}

_Bool sump_handle_command_byte(unsigned char input_byte) {
  ...
  case RX_COMMAND_PROCESS:
    ...
    case 0x80: {
      ...
      PR5 = (((uint32_t)(period) >> 16) & 0xFFFF);
      PR4 = ((uint32_t)(period)&0xFFFF);
...
_Bool sump_acquire_samples(void) {
