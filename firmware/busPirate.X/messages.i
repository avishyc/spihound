...
void bp_message_write_buffer(unsigned long strptr) {
  ...
  do {
    ...
    switch (index) {
    case 0:
      ch = ((uint16_t)(__builtin_tblrdl(strptr))&0xFF);
      index++;
      break;

    case 1:
      ch = (((uint16_t)(__builtin_tblrdl(strptr)) >> 8) & 0xFF);
      index++;
      break;

    case 2:
      ch = ((uint16_t)(__builtin_tblrdh(strptr))&0xFF);
      strptr += 2;
      index = 0;
      break;
    }
...
void print_help(void) {
  bp_message_write_line(__builtin_tbladdress(HLP1000_str));
  bp_message_write_line(__builtin_tbladdress(HLP1001_str));
  bp_message_write_line(__builtin_tbladdress(HLP1002_str));
  bp_message_write_line(__builtin_tbladdress(HLP1003_str));
  bp_message_write_line(__builtin_tbladdress(HLP1004_str));
  bp_message_write_line(__builtin_tbladdress(HLP1005_str));
  bp_message_write_line(__builtin_tbladdress(HLP1006_str));
  bp_message_write_line(__builtin_tbladdress(HLP1007_str));
  bp_message_write_line(__builtin_tbladdress(HLP1008_str));
  bp_message_write_line(__builtin_tbladdress(HLP1009_str));
  bp_message_write_line(__builtin_tbladdress(HLP1010_str));
  bp_message_write_line(__builtin_tbladdress(HLP1011_str));
  bp_message_write_line(__builtin_tbladdress(HLP1012_str));
  bp_message_write_line(__builtin_tbladdress(HLP1013_str));
  bp_message_write_line(__builtin_tbladdress(HLP1014_str));
  bp_message_write_line(__builtin_tbladdress(HLP1015_str));
  bp_message_write_line(__builtin_tbladdress(HLP1016_str));
  bp_message_write_line(__builtin_tbladdress(HLP1017_str));
  bp_message_write_line(__builtin_tbladdress(HLP1018_str));
  bp_message_write_line(__builtin_tbladdress(HLP1019_str));
  bp_message_write_line(__builtin_tbladdress(HLP1020_str));
  bp_message_write_line(__builtin_tbladdress(HLP1021_str));
  bp_message_write_line(__builtin_tbladdress(HLP1022_str));
}
...
_Bool agree(void) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1135_str));
