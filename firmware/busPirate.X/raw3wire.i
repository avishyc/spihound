...
static _Bool cs_line = 0;
# 47 "../raw3wire.c"
static void setup_raw3wire(const _Bool write_with_read,
                           const _Bool cs_line_state);
...
void raw3wire_print_settings(void) {
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW3WIRE_MODE_HEADER_str));
...
void raw3wire_print_pins_state(void) { bp_message_write_line(__builtin_tbladdress(MSG_SPI_PINS_STATE_str)); }

void setup_raw3wire(const _Bool write_with_read, const _Bool cs_line_state) {
