...
void raw2wire_start(void) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_I2C_START_str));
  bp_message_write_line(__builtin_tbladdress(MSG_I2C_START_BIT_str));
}

void raw2wire_stop(void) {
  bitbang_i2c_stop();
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_I2C_STOP_str));
  bp_message_write_line(__builtin_tbladdress(MSG_I2C_STOP_BIT_str));
}

void raw2wire_print_settings(void) {
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_MODE_HEADER_str));
...
void raw2wire_run_macro(const uint16_t macro_id) {
  ...
  case RAW2WIRE_MACRO_MENU:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_MACRO_MENU_str));
    break;
...
void raw2wire_print_pins_state(void) { bp_message_write_line(__builtin_tbladdress(MSG_I2C_PINS_STATE_str)); }

void trigger_atr(void) {
  bp_message_write_line(__builtin_tbladdress(MSG_RAW2WIRE_ATR_TRIGGER_INFO_str));
...
void read_atr_header(void) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_REPLY_HEADER_str));
  ...
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_PROTOCOL_HEADER_str));
  switch ((buffer[0] >> 4)) {
  case 0x08:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_PROTOCOL_SERIAL_str));
    break;

  case 0x09:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_PROTOCOL_3WIRE_str));
    break;

  case 0x0A:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_PROTOCOL_2WIRE_str));
    break;

  case 0x0F:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_RFU_str));
    break;

  default:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_PROTOCOL_UNKNOWN_str));
    break;
  }
  bp_write_line("");

  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_READ_TYPE_HEADER_str));
  if ((buffer[1] & 0x80) == 0) {
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_READ_TYPE_TO_END_str));
  } else {
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_READ_TYPE_VARIABLE_LENGTH_str));
  }
  bp_write_line("");

  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_DATA_UNITS_HEADER_str));
  uint8_t length = (buffer[1] >> 3) & 0b00001111;
  switch (length) {
  case 0:
    bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_DATA_UNITS_NO_INDICATION_str));
    break;
  ...
  bp_message_write_buffer(__builtin_tbladdress(MSG_RAW2WIRE_ATR_DATA_UNIT_LENGTH_str));
