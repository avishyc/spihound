...
# 25 "../selftest.c" 2
# 46 "../selftest.c"
void check_result(_Bool obtained, _Bool expected);
# 56 "../selftest.c"
void perform_pins_state_test(_Bool state);
# 66 "../selftest.c"
...
uint8_t perform_selftest(_Bool show_progress, _Bool jumper_test) {
  ...
  if (show_progress && jumper_test) {
    ...
    bp_message_write_line(__builtin_tbladdress(BPMSG1163_str));
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1164_str));



  PORTDbits.RD5 = 1;
  TRISDbits.TRISD5 = 0;
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1165_str));
  check_result(PORTDbits.RD5, 1);
  PORTDbits.RD5 = 0;
  TRISDbits.TRISD5 = 1;
  ...
  PORTBbits.RB8 = 1;
  TRISBbits.TRISB8 = 0;
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1166_str));
  check_result(PORTBbits.RB8, 1);
  PORTBbits.RB8 = 0;



  bp_enable_pullup();
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1167_str));
  check_result(PORTEbits.RE4, 1);



  bp_disable_pullup();
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1168_str));
  check_result(PORTEbits.RE4, 0);



  bp_enable_voltage_regulator();
  bp_delay_ms(2);
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1169_str));
  check_result(PORTBbits.RB9, 1);





  bp_message_write_line(__builtin_tbladdress(BPMSG1265_str));


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1266_str));
  check_result(PORTDbits.RD10, 1);


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1267_str));
  check_result(PORTDbits.RD9, 1);


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1268_str));
  check_result(PORTDbits.RD11, 1);



  bp_message_write_buffer(__builtin_tbladdress(BPMSG1269_str));
  check_result(eeprom_test(), 1);





  bp_message_write_line(__builtin_tbladdress(BPMSG1170_str));
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1270_str));
  perform_adc_test(15, 0x307 - 0x50, 0x307 + 0x50);
  ...
  perform_adc_test(2, 0x307 - 0x50, 0x307 + 0x50);
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1172_str));
  bp_delay_ms(2);
  perform_adc_test(5, 0x307 - 0x50, 0x307 + 0x50);
  bp_disable_5v0_pullup();
  ...
  if (jumper_test) {
    ...
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1174_str));
    perform_adc_test(1, 0x200 - 0x50, 0x200 + 0x50);
  }
  ...
  perform_adc_test(0, 0x200 - 0x50, 0x200 + 0x50);
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1172_str));
  bp_delay_ms(2);
  perform_adc_test(5, 0x200 - 0x50, 0x200 + 0x50);
  bp_disable_3v3_pullup();
# 260 "../selftest.c"
  bp_disable_adc();
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1175_str));
  TRISD &= ~(0b0000000000000010 + 0b0000000000000100 + 0b0000000000001000 + 0b0000000000010000);
  LATD |= (0b0000000000000010 + 0b0000000000000100 + 0b0000000000001000 + 0b0000000000010000);
  bp_delay_ms(100);
  perform_pins_state_test(1);
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1176_str));
  LATD &= ~(0b0000000000000010 + 0b0000000000000100 + 0b0000000000001000 + 0b0000000000010000);
  if (jumper_test) {
    bp_enable_3v3_pullup();
    bp_enable_pullup();
  ...
  if (jumper_test) {
    ...
    bp_message_write_line(__builtin_tbladdress(BPMSG1177_str));
    TRISD |= (0b0000000000000010 + 0b0000000000000100 + 0b0000000000001000 + 0b0000000000010000);
    bp_delay_ms(100);
    perform_pins_state_test(1);
    bp_disable_3v3_pullup();
  ...
  if (show_progress && jumper_test) {
    ...
    bp_enable_mode_led();
    bp_enable_usb_led();
    bp_message_write_line(__builtin_tbladdress(BPMSG1178_str));
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1179_str));
  bp_write_dec_byte(errors);
  bp_message_write_line(__builtin_tbladdress(BPMSG1180_str));
...
void perform_pins_state_test(_Bool state) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1181_str));
  check_result(PORTDbits.RD1, state);


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1182_str));
  check_result(PORTDbits.RD2, state);


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1183_str));
  check_result(PORTDbits.RD3, state);


  bp_message_write_buffer(__builtin_tbladdress(BPMSG1184_str));
  check_result(PORTDbits.RD4, state);
}
...
void check_result(_Bool obtained, _Bool expected) {
  if (obtained == expected) {
    ...
    bp_message_write_line(__builtin_tbladdress(BPMSG1186_str));
    errors++;
  }
}
