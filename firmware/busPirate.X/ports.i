...
void setPort(short p,short val){
    if (p==(short) 1) {PORTDbits.RD4 = (unsigned char) val;}
    if (p==(short) 2) {PORTDbits.RD1 = (unsigned char) val;}
    if (p==(short) 0) {PORTDbits.RD2 = (unsigned char) val;}
}
...
void readByte(unsigned char *data){
        ...
        if(bufBytes==0){
                ...
                bh=user_serial_read_byte();
                bl=user_serial_read_byte();
                bufBytes=(bh<<8)|bl;
...
unsigned char readTDOBit(){return PORTDbits.RD3;}
