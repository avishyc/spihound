...
extern int errno;
# 20 "../onboard_eeprom.c" 2

# 1 "../onboard_eeprom.h" 1
# 21 "../onboard_eeprom.h"
# 1 "../configuration.h" 1
# 22 "../onboard_eeprom.h" 2
# 30 "../onboard_eeprom.h"
...
# 107 "../onboard_eeprom.c"
static void eeprom_i2c_send_ack(_Bool ack);
# 118 "../onboard_eeprom.c"
static _Bool eeprom_i2c_get_ack(void);
...
# 147 "../onboard_eeprom.c"
static uint8_t eeprom_read_byte(uint16_t address);
# 162 "../onboard_eeprom.c"
static _Bool eeprom_write_byte(uint8_t value, uint16_t address);
...
_Bool eeprom_test(void) {
  ...
  _Bool write_protection = PORTDbits.RD11;
  ...
  _Bool result = (eeprom_read_byte(0) == 0x10);


  eeprom_write_byte(0xFF, 0);


  PORTDbits.RD11 = write_protection;
...
inline _Bool eeprom_i2c_get_ack(void) {


  return I2C1STATbits.ACKSTAT;
}

void eeprom_i2c_send_ack(_Bool ack) {
...
uint8_t eeprom_i2c_read(void) {
  ...
  return ((uint16_t)(I2C1RCV)&0xFF);
}

void eeprom_i2c_setup(void) {
# 291 "../onboard_eeprom.c"
  I2C1CON &= ~(0x00000400 | 0x00001000 | 0x00000100);
...
_Bool eeprom_write_byte(const uint8_t value, const uint16_t address) {
  ...
  _Bool result = eeprom_i2c_get_ack();
