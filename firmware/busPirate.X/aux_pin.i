...
# 230 "../aux_pin.c"
  OC5CON1 =
      (0b110 << 0x00000000) | (0 << 0x00000003) |
      (0 << 0x00000004) | (0 << 0x00000007) |
      (0 << 0x0000000A) | (0 << 0x0000000D);
# 249 "../aux_pin.c"
  T2CONbits.TON = 1;
...
# 293 "../aux_pin.c"
  if (state.mode == AUX_MODE_PWM) {
    ...
    RPOR10bits.RP20R = 0;
    bp_message_write_line(__builtin_tbladdress(BPMSG1028_str));
    state.mode = AUX_MODE_IO;

    if (cmdbuf[((cmdstart + 1) & (256 - 1))] == 0x00) {
  ...
  if (!valid_arguments) {
    ...
    bp_message_write_line(__builtin_tbladdress(BPMSG1029_str));
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1030_str));
  ...
  if (!valid_arguments) {
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1033_str));
...
# 373 "../aux_pin.c"
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1034_str));
  state.mode = AUX_MODE_PWM;
}
...
void bp_frequency_counter_setup(void) {
  ...
  if (state.mode == AUX_MODE_PWM) {
    bp_message_write_line(__builtin_tbladdress(BPMSG1037_str));
    return;
  }

  bp_message_write_buffer(__builtin_tbladdress(BPMSG1038_str));
  stop_timers();
  ...
  RPINR3bits.T2CKR = 20;
# 408 "../aux_pin.c"
  T2CON = (1 << 0x00000001) | (1 << 0x00000003) |
          (1 << 0x00000004) | (1 << 0x00000005);
  ...
  if (frequency > 0x3FFF) {
    ...
    bp_message_write_buffer(__builtin_tbladdress(BPMSG1245_str));
    T2CONbits.TCKPS0 = 0;
    T2CONbits.TCKPS1 = 0;
    frequency = poll_frequency_counter_value();
  }
  ...
  if (frequency > 3999) {
    ...
    bp_message_write_line(__builtin_tbladdress(MSG_PWM_HZ_MARKER_str));
  } else {
    if (frequency > 0) {
      bp_message_write_buffer(__builtin_tbladdress(BPMSG1245_str));
    ...
    write_marker:
      ...
      bp_message_write_line(__builtin_tbladdress(MSG_PWM_FREQUENCY_TOO_LOW_str));
    }
  }
...
uint32_t average_sample_frequency(const uint16_t count) {
  ...
  TMR4 = 0x0000;
# 647 "../aux_pin.c"
  T4CON = (1 << 0x0000000F) | (1 << 0x00000003);
# 662 "../aux_pin.c"
  IC2CON1 = (0b011 << 0x00000000) | (0b00 << 0x00000005) |
            (0b011 << 0x0000000A) |
            (0 << 0x0000000D);
# 677 "../aux_pin.c"
  IC2CON2 = (0b10100 << 0x00000000) |
            (0 << 0x00000006) |
            (0 << 0x00000007) | (0 << 0x00000008);
# 693 "../aux_pin.c"
  IC1CON1 = (0b011 << 0x00000000) | (0b00 << 0x00000005) |
            (0b010 << 0x0000000A) |
            (0 << 0x0000000D);
# 708 "../aux_pin.c"
  IC1CON2 = (0b10100 << 0x00000000) |
            (0 << 0x00000006) |
            (0 << 0x00000007) | (0 << 0x00000008);
# 769 "../aux_pin.c"
...
void bp_aux_pin_set_high_impedance(void) {
  ...
  bp_message_write_buffer(__builtin_tbladdress(BPMSG1039_str));
}
...
# 912 "../aux_pin.c"
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1040_str));
}
...
# 951 "../aux_pin.c"
  ...
  bp_message_write_line(__builtin_tbladdress(BPMSG1041_str));
}

_Bool bp_aux_pin_read(void) {
# 994 "../aux_pin.c"
  switch ((((uint8_t)mode_configuration.alternate_aux) & ((1 << (uint8_t)2) - 1))) {
  case 0:
    TRISDbits.TRISD5 = 1;
    __builtin_nop();
    __builtin_nop();
...
# 1066 "../aux_pin.c"
  ...
  consumewhitechars();
  pwm_period = getint();
  if ((mode_configuration.command_error == 1)|| (pwm_period > 180)) {
    mode_configuration.command_error = 0;
    bp_message_write_line(__builtin_tbladdress(BPMSG1254_str));
...
# 1131 "../aux_pin.c"
    ...
    T2CONbits.TON = 1;
    bp_message_write_line(__builtin_tbladdress(BPMSG1255_str));
    state.mode = AUX_MODE_PWM;
